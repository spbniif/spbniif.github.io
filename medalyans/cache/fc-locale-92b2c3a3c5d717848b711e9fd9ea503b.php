<?php return array (
  ...
  'plugins.themes.healthSciences.register.noAccount' => 'У Вас нет аккаунта?',
  'plugins.themes.healthSciences.register.loginHere' => 'Войти в систему',
  'plugins.themes.healthSciences.register.registerHere' => 'Регистрация',
...
<p>Система не сможет автоматически перезаписать файл конфигурации. Чтобы применить ваши измененные настройки конфигурации, вам нужно открыть <tt>config.inc.php</tt> в подходящем текстовом редакторе и заменить его содержимое содержимым текстового поля ниже.</p>',
  ...
  'plugins.themes.healthSciences.search.params' => 'Поиск',
  'plugins.themes.healthSciences.search.resultsFor' => 'Результаты поиска для <em>{$query}</em>',
  'manager.setup.lockssDescription' => 'Open Journal Systems поддерживает систему LOCKSS (Lots of Copies Keep Stuff Safe), чтобы быть уверенным в безопасном и постоянном архиве для контента журнала. Если ваш журнал принят для архивирования контента в глобальную сеть LOCKSS или участвует в частной сети LOCKSS помимо PKP PN, включите здесь необходимые настройки:',
...
Вы также (при необходимости) можете указать пользователю причину отключения его учетной записи.',
  ...
  'author.submit.uploadInstructions' => '<p>Чтобы отправить материал в этот журнал, выполните следующие шаги.</p>
<ol>
...
(После сохранения могут быть добавлены дополнительные комментарии.)',
  ...
  'user.register.form.privacyConsent' => 'Да, я даю согласие на сбор и хранение моих данных в рамках <a href="{$privacyUrl}" target="_blank">политики конфиденциальности</a> этого журнала.',
  'user.register.form.emailConsent' => 'Да, я хочу, чтобы меня уведомляли о новых публикациях и объявлениях во всех журналах, в которых я зарегистрирован.',
  'plugins.themes.healthSciences.register.haveAccount' => 'У Вас уже есть аккаунт?',
...
<p>OJS на текущий момент была протестирована только на MySQL и PostgreSQL, хотя другие СУБД, поддерживаемые <a href="http://adodb.sourceforge.net/" target="_blank">ADOdb</a>, также могут работать (полностью или частично). Отчеты о совместимости и/или исправления кода для альтернативных СУБД можно высылать команде проекта OJS.</p>',
  'installer.preInstallationInstructions' => '<h4>Шаги подготовки к установке</h4>
