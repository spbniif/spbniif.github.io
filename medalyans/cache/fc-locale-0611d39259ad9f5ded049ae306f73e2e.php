<?php return array (
  ...
  'user.gossip.description' => 'Пишите здесь заметки о данном рецензенте, которые вы хотели бы сделать видимыми другим администраторам, менеджерам журнала, редакторам и помощникам редактора. Заметки будут видны при назначениях на рецензию в будущем.',
  ...
  'user.orcid' => 'ORCID iD',
  'user.orcid.orcidInvalid' => 'Указанный вами ORCID iD не корректен. Пожалуйста, добавьте полный URI (например, «http://orcid.org/0000-0002-1825-0097»).',
