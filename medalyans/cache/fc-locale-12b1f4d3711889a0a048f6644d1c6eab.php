<?php return array (
  ...
  'manager.setup.reviewOptions.showEnsuringLink' => 'Добавлять ссылки на <a href="javascript:openHelp(\'{$blindReviewHelpId}\')" class="action">«Обеспечение слепого рецензирования»</a> на страницах, где авторы и рецензенты загружают файлы.',
