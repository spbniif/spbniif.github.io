...
unset($_smarty_tpl_vars);
 ?>
	...
	<?php if ($this->_tpl_vars['enableContextPrivacyStatement']): ?>
		<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'privacyStatementArea')); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php $this->_tag_stack[] = array('fbvFormSection', array('label' => "manager.setup.privacyStatement",'description' => "manager.setup.privacyStatement.description")); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
