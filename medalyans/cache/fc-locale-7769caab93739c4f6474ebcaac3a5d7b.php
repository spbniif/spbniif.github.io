<?php return array (
  ...
  'plugins.generic.usageStats.noCounterBotList' => 'Список ботов COUNTER «{$botlist}» нельзя использовать. Для этого может быть пара причин. Проверьте, что файл списка в каталоге «lib/pkp/plugins/generic/usageStats/lib/counter». Также проверьте права на эту папку и то, что в ней находится только один файл.',
  ...
  'plugins.reports.usageStats.optout.displayName' => 'Информация о конфиденциальности модуля «Статистика использования»',
  'plugins.reports.usageStats.optout.description' => 'Информация о конфиденциальности модуля «Статистика использования»',
